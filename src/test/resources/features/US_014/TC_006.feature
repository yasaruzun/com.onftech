  ...
  Feature: US014 user tests on Trendlifebuy.com
    ...
    Scenario: TC_006_01     About us page review is display
    ...
    Scenario: TC_006_02    About us page review is display
    ...
    Scenario: TC_006_03   About us page review is display
    ...
    Scenario: TC_006_04 About us page review is display
