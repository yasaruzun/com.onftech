Feature: US_041 As an administrator, I want the support ticket page to be in order to be able to handle the opened support tickets.
  ...
  Scenario:TC_014 It should be verified that the unassigned ticket can be assigned under Agent Assign
    ...
    And selects an account for the ticket that is "Unassigned" under the "Agent Asign" heading.
    When tests that "Unassigned" is replaced by an account name.