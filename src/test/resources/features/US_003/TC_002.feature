Feature:US_003 Verify that all categories under the All Categories menu are visible and active
  ...
  Scenario:TC_002 Verify that the categories Computer & Accessories, Electronics Devices,
                  Watches & Accessories, Fashions, Toys,Kids&Babies, Bag&Shoes, Lifestyle&Home, TV & Home Appliances, Auto Mobiles & bikes are active
